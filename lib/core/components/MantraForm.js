...
export default class MantraForm extends MantraComponent {
    ...
    constructor({ name, model }) {
        ...
        this._isValidConstructor({ model });
        this.model = model;
    };
     ...
     * @returns {Error|void} Throw error if there was not a model property defined at the class constructor params
     */
    _isValidConstructor({ model }) {
