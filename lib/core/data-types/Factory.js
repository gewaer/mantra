...
export default class DataTypeFactory {
     ...
     * @param {string} type - Identifier to select a Mantra Data Type.
     * @return {MantraDataType} A data type class.
     */
    ...
    static isValidType(type) {
        if (!DATA_TYPES.hasOwnProperty(type)) return { valid: false, reason: 'Must provide a supported data type' };
        return { valid: true };
    };
     ...
     * @return {MantraDataType} An instanced data type class.
     */
