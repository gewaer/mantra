 ...
 * @typedef {Object} MantraModelParams
...
export default class MantraModel {
    ...
    /**
     * Resolve the MantraModelConfig needed from the schema.
     * @param {MantraModelParams} - Properties used to resolve a proper MantraModelConfig.
     ...
     * @param {MantraModelParams} - The constructor params to resolve a MantraModelConfig from the MantraSchema class.
     * @returns {MantraModelConfig} - Configuration to base the class.
     */
    _get({ name, schema }) {
    ...
    /**
     * Resolve the MantraModelConfig needed from the schema.
     * @param {MantraModelParams} config - The constructor params.
     ...
     * @param {MantraModelParams} value - The constructor params to check its validity.
